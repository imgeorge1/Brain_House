...
const VideoRender = ({
  ...
  if (isThirtyPath) {
    return videoUrls.map((url, index) => (
        <div className="w-full max-w-4xl mx-auto h-[380px] overflow-hidden">
      <iframe
        className="w-full h-[680px] md:h-[460px] -translate-y-[200px] "
    ...
    return (
      <div>
        <div className="w-full max-w-4xl mx-auto h-[380px] overflow-hidden">
        <iframe
          className="w-full h-[640px] md:h-[380px] -translate-y-[200px]" 
