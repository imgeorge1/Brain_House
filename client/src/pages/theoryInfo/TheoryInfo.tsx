      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex justify-center w-[90%] md:w-[60%]">
          ...
          lg:text-[1rem] min-[1200px]:text-[1.2rem] 2xl:text-[1.5rem] min-[2000px]:text-[2rem]">
            <p className="my-2 font-roboto font-semibold">
              ...
              მოხვდი, სადაც თეორიას 8 საათში სწავლობენ ! "
            </p>
            <p className="my-2 font-roboto font-semibold">
        ...
        <div className="mt-6 md:w-[60%]">
          ...
          >
            ...
            <p className="my-2 font-roboto">👉ამ კურსის დახმარებით, 8 საათში, შეგიძლია სრული მასალის გავლა, დაზეპირების გარეშე🎯</p>
            ...
            <p className="my-2 font-roboto font-semibold">🎁 95 ლარს შეადგენს🎁</p>
