  ...
  return (
    <div className="border-4 mt-20">
      <div className="flex flex-col justify-center items-center">
        <iframe
          src="https://drive.google.com/file/d/1wH74l_vZulyBGxa1wwagN8QpbqCUvRr1/preview"
      ...
      <div className="flex flex-col justify-center items-center">
        <h1 className="font-roboto text-2xl text-center mb-4">
          ბექა ეჯიბიშვილი:
        </h1>
        <div className="flex justify-center w-[90%] md:w-[60%]">
          <div
            className="w-full mix-blend-difference text-white text-[0.52rem] 
          ...
          >
            <p className="my-2 font-roboto font-semibold">
              " შეიძლება ვინმემ 1 თვე მოანდომა სწავლას, ვიღაცამ 2 თვე, ან სულაც
              ვერ ისწავლა, მაგრამ შენ იქ მოხვდი, სადაც თეორიას 8 საათში
              სწავლობენ ! "
            </p>
            <p className="my-2 font-roboto font-semibold">
              უნდა დაიჯერო საკუთარი თავის და რაც შეეხება კურსს, თავად
              დარწმუნდები მის შესაძლებლობებში, როდესაც გამოცდი "
            </p>
            <p className="my-2 font-roboto ">
              თეორიის ჭკვიანი პროგრამის ავტორი, თეორიული კურსის მენტორი ,
              5000-ზე მეტი ჩატარებული ლექცია ;
            </p>
            <p className="my-2 font-roboto ">
          ...
          <img
            className="w-[60%] object-cover overflow-hidden"
            src={beqaImage}
          />
        </div>
        ...
        <div className="mt-6 md:w-[60%]">
          ...
          >
            <h1 className="font-roboto text-2xl text-center my-4">
              კურსის შესახებ ინფორმაცია
            </h1>
            <p className="my-2 font-roboto">
              🚀პირდაპირ გეტყვი, რომ ეს კურსი მხოლოდ მათთვის არის, ვისაც
              ნამდვილად სურს თეორიის შესწავლა.
            </p>
            <p className="my-2 font-roboto">
              👉ამ კურსის დახმარებით, 8 საათში, შეგიძლია სრული მასალის გავლა,
              დაზეპირების გარეშე🎯
            </p>
            <p className="my-2 font-roboto">
              ეს არის უნიკალური პროგრამა, რომლის მეშვეობით, 2000-ზე მეტმა
              მოსწავლემ ჩააბარა გამოცდა🎯{" "}
            </p>
            <p className="my-2 font-roboto">
              გაინტერესებს, რატომ აქვს კურსს ასეთი შედეგი?
            </p>
            <p className="my-2 font-roboto">
              ✅სწავლობ ჩვენს ვებ გვერდზე, დისტანციურ რეჟიმში, როცა და სადაც
              გინდა ;{" "}
            </p>
            <p className="my-2 font-roboto">
              ✅ზოგავ ძალიან დიდ დროსა და ფინანსებს ;{" "}
            </p>
            <p className="my-2 font-roboto">
              ✅თეორიას სწავლობ თემების სპეციალური მიმდევრობით ;{" "}
            </p>
            <p className="my-2 font-roboto">
              ✅ყოველი ლექციის შემდეგ, იწყება ტესტირება, რითიც აზუსტებ შენს
              ცოდნას ;{" "}
            </p>
            <p className="my-2 font-roboto">
              ✅ სწავლობ, დაზეპირებისა და ზედმეტი სტრესის გარეშე და იღებ ძალიან
              მაგარ შედეგს ;{" "}
            </p>
            <p className="my-2 font-roboto">
              🗣️ნათქვამია, გაგონილს ნანახი სჯობიაო, ამიტომ გაძლევ შესაძლებლობას,
              თავად დარწმუნდე ამ ყველაფერში :{" "}
            </p>
            <p className="my-2 font-roboto">
              გადადი ბმულზე, დაესწარი კურსის პირველ, ანუ 21-ე ლექციას, სრულიად
              უფასოდ 👇
            </p>
            <a
              href="https://www.brainhouse.ge/tickets/21"
              className="text-indigo-500 my-2"
            >
              21-ე ლექცია
            </a>
            <p className="my-2 font-roboto">
              👉ლექციის შემდეგ, ავტომატურად დაიწყება ტესტირება და შენი ცოდნა,
              დაადასტურე ტესტირებით✅
            </p>
            <p className="my-2 font-roboto">
              ✅კურსი, შეძენიდან 30 დღეა აქტიური ;
            </p>
            <p className="my-2 font-roboto">
              ნახავ, რომ ძალიან მაგარი შედეგი გექნება🎯
            </p>
            <p className="my-2 font-roboto">
              🎄 მოქმედებს -80% საახალწლო ფასდაკლება და საფასური:{" "}
            </p>
            <p className="my-2 font-roboto font-semibold">
              🎁 95 ლარს შეადგენს🎁
            </p>
            ...
            <p className="my-2 font-roboto">
              თუ დამატებითი კითხვები გექნება, დამირეკე 📞
            </p>
            <p className="my-2 font-roboto">🗣️ბექა ეჯიბიშვილი - 599795767</p>
            <p className="my-2 font-roboto">
              როდესაც კურსის შეძენას გადაწყვეტ 👇
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 md:w-[60%]">
          ...
          >
            ...
            <p className="my-2 font-roboto">
              🧠გახსენი ბრაუზერი (google chrome, opera ან რომელიმე სხვა ){" "}
            </p>
            <p className="my-2 font-roboto">
              ბრაუზერში ჩაწერე brainhouse.ge და მარჯვნივ ნახავთ ღილაკს " შესვლა"
              .
            </p>
            <p className="my-2 font-roboto">
              👉გაიარეთ რეგისტრაცია, მიუთითე სწორი ინფორმაცია (მათ შორის
              ელ-ფოსტის მისამართი).
            </p>
            <p className="my-2 font-roboto">
              👉ამის შემდეგ, გამოვა თეთრი ფანჯარა სადაც იქნება საბანკო
              რეკვიზიტები მითითებული.
            </p>
            <p className="my-2 font-roboto">
              ✅თანხის გადახდის შემდეგ, გადმოგვიგზავნე ჩარიცხვის სქრინი და
